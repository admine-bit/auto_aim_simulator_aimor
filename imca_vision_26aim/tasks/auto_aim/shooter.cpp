...
Shooter::Shooter(const std::string & config_path) : last_command_{false, false, 0, 0}
{
  ...
  first_tolerance_ = yaml["first_tolerance"].as<double>() *3.14159/180.0;    // degree to rad
  second_tolerance_ = yaml["second_tolerance"].as<double>() *3.14159/180.0;  // degree to rad
